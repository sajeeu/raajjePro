...
This screen has no mockup. **Propose the layout and get approval before writing implementation code** — state the structure, which existing components it reuses, what each state looks like, and the primary action.
