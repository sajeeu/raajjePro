---
description: Build Phase 19b — Help, Support & Feedback  new in Round 15
---

Build **Phase 19b — Help, Support & Feedback  new in Round 15** of RaajjePro.

## Read first

1. `01_Development_Plan_v5.md` §0.0 — the precedence rule. Where §0.1–0.3 conflict with a later section, the later section wins.
2. **§Phase 19b** — the full specification for this phase, including its **Done when** criteria.
...
- Build exactly what §Phase 19b describes. Do not build ahead into a later phase.
