---
description: Build Phase 17.1 — Core booking machine, payment attestation & the locked agreement
---

Build **slice 17.1** of RaajjePro's Phase 17 (Bookings Module) — *Core booking machine, payment attestation & the locked agreement*.

## Read first

1. `01_Development_Plan_v5.md` §0.0 — the precedence rule.
2. **§Phase 17**, specifically the 17.1 subsection, and **§Phase 17's `17.1 — Done when` list, which is yours. The other three slices have their own and you finish against none of them.**
...
- Finish against **`17.1 — Done when`**, plus the standing rule above it that no endpoint in the module returns a phone number — that one applies to every slice, over the endpoints this one adds.
