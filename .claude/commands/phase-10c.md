---
description: Build Phase 10c — Admin Ops Dashboard
---

Build **Phase 10c — Admin Ops Dashboard** of RaajjePro.

## Read first

1. `01_Development_Plan_v5.md` §0.0 — the precedence rule. Where §0.1–0.3 conflict with a later section, the later section wins.
2. **§Phase 10c** — the full specification for this phase, including its **Done when** criteria.
3. §1b introductory pricing — this phase depends on it.
...
- Build exactly what §Phase 10c describes. Do not build ahead into a later phase.
