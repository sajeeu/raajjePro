---
description: Build Phase 10a — Provider Billing UI & Admin Panel
---

Build **Phase 10a — Provider Billing UI & Admin Panel** of RaajjePro.

## Read first

1. `01_Development_Plan_v5.md` §0.0 — the precedence rule. Where §0.1–0.3 conflict with a later section, the later section wins.
2. **§Phase 10a** — the full specification for this phase, including its **Done when** criteria.
3. §1b The manual payment mechanism · §1e — this phase depends on it.
...
- Build exactly what §Phase 10a describes. Do not build ahead into a later phase.
