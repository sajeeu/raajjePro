---
description: Build Phase 1 — Design System & Shared UI Foundation
---

Build **Phase 1 — Design System & Shared UI Foundation** of RaajjePro.

## Read first

1. `01_Development_Plan_v5.md` §0.0 — the precedence rule. Where §0.1–0.3 conflict with a later section, the later section wins.
2. **§Phase 1** — the full specification for this phase, including its **Done when** criteria.
3. §1 Mockup Inventory (the divergence table — seven screens need redrawing) — this phase depends on it.
...
- Build exactly what §Phase 1 describes. Do not build ahead into a later phase.
