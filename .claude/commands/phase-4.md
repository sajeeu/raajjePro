---
description: Build Phase 4 — Categories Module
---

Build **Phase 4 — Categories Module** of RaajjePro.

## Read first

1. `01_Development_Plan_v5.md` §0.0 — the precedence rule. Where §0.1–0.3 conflict with a later section, the later section wins.
2. **§Phase 4** — the full specification for this phase, including its **Done when** criteria.
3. §1c Category booking mode · §1d Categories — this phase depends on it.
...
- Build exactly what §Phase 4 describes. Do not build ahead into a later phase.
