---
description: Build Phase 5 — Provider Profiles
---

Build **Phase 5 — Provider Profiles** of RaajjePro.

## Read first

1. `01_Development_Plan_v5.md` §0.0 — the precedence rule. Where §0.1–0.3 conflict with a later section, the later section wins.
2. **§Phase 5** — the full specification for this phase, including its **Done when** criteria.
3. §1c the contact rule · §1e · §1g Local preference — this phase depends on it.
...
- Build exactly what §Phase 5 describes. Do not build ahead into a later phase.
