---
description: Build Phase 12 — Service Preview (Public Listing Page)
---

Build **Phase 12 — Service Preview (Public Listing Page)** of RaajjePro.

## Read first

1. `01_Development_Plan_v5.md` §0.0 — the precedence rule. Where §0.1–0.3 conflict with a later section, the later section wins.
2. **§Phase 12** — the full specification for this phase, including its **Done when** criteria.
3. §1e · §1f (metrics are displayed here) · §1c booking mode affordance — this phase depends on it.
...
- Build exactly what §Phase 12 describes. Do not build ahead into a later phase.
