---
description: Build Phase 21 — Observability & Crash Reporting
---

Build **Phase 21 — Observability & Crash Reporting** of RaajjePro.

## Read first

1. `01_Development_Plan_v5.md` §0.0 — the precedence rule. Where §0.1–0.3 conflict with a later section, the later section wins.
2. **§Phase 21** — the full specification for this phase, including its **Done when** criteria.
...
- Build exactly what §Phase 21 describes. Do not build ahead into a later phase.
