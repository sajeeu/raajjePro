...
mid-build**: revision 5.34's §0.0 item 19 makes a full bank-statement match
...
| | |
|---|---|
| `01_Development_Plan_v5.md` | **The single source of truth**, revision 5.34. Every product decision. Read §0.0 first — it is a precedence rule |
